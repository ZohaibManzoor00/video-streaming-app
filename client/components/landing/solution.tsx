...
const features = [
  {
    ...
    className: "hover:bg-red-500/10 hover:dark:bg-red-500/50 transition-all duration-500 ease-out",
    content: (
      <>
        <Safari
  ...
  },
  {
    ...
    className:
      "order-3 xl:order-none hover:bg-blue-500/10 hover:dark:bg-blue-500/50 transition-all duration-500 ease-out",
    content: (
      <Safari
        src={`/javascript-logo.png`}
        url="https://acme.ai"
  ...
  },
  {
    ...
    className:
      "md:row-span-2 hover:bg-orange-500/10 hover:dark:bg-orange-500/50 transition-all duration-500 ease-out",
    content: (
      <>
        <FlickeringGrid
  ...
  },
  {
    ...
    className:
      "flex-row order-4 md:col-span-2 md:flex-row xl:order-none hover:bg-green-500/10 hover:dark:bg-green-500/50 transition-all duration-500 ease-out",
    content: (
      <>
